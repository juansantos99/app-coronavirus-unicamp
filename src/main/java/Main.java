				...
				case 1:
					...
					if (iAction == 1) {
						...
						do {
							...
							System.out.println("5 - Visualizar o prontuario");
							...
							switch (opcao) {
								...
								case 2:
									...
									MedicalRecord patient_medical_record = dbMedicalRecord.createMedicalRecord(
											medical_record_date, patient_status, patient_cpf, iId, patient_diagnosis,
											0);
									...
									System.out.println(
											"Data de criação do prontuário: " + patient_medical_record.getDate());
									System.out.println(
											"Descrição do diagnóstico:" + patient_medical_record.getDiagnosis());
				...
				case 2:
					...
					if (iAction == 1) {
						...
						do {
							...
							System.out.println("3 - Visualizar Prontuario");
							System.out.println("7 - Sair");
							opcao = scan.nextInt();
							switch (opcao) {
								/* Cadastrar Sintomas */
								case 1:
									...
									System.out.println("Digite os Sintomas que possue pelo id");
									for (i = 0; i < sint; i++) {
										int idSintoma = scan.nextInt();
										SymptonsPatient simyptonspatient = dbSymptonsPatient.RegisterSymptons(idSintoma,
												iCpf);
									}
									break;
								case 2:
