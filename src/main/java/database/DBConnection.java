...
public class DBConnection {
    ...
    private static void connect() {
        try (Connection connection = DriverManager.getConnection("jdbc:sqlite:corona.db")) {
            ...
            statement.execute("CREATE TABLE IF NOT EXISTS MEDICAL_RECORD( ID INTEGER PRIMARY KEY AUTOINCREMENT, STATUS VARHCAR, RECORD_DATE TEXT, PATIENT_CPF INTEGER, DOCTOR_ID INTEGER, DIAGNOSTICS VARCHAR, EXAMS_ID INTEGER )");
