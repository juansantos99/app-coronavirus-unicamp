...
public class DBConnection {
    ...
    private static Connection connect() {
        try (Connection connection = DriverManager.getConnection("jdbc:sqlite:corona.db")) {
            ...
            statement.execute("CREATE TABLE IF NOT EXISTS MEDICAL_RECORD( ID INTEGER PRIMARY KEY AUTOINCREMENT, STATUS VARCHAR, RECORD_DATE VARCHAR, PATIENT_CPF INTEGER, DOCTOR_ID INTEGER, DIAGNOSIS VARCHAR )");
