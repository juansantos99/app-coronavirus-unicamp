...
public class DBConnection {
    ...
    private static void connect() {
        try (Connection connection = DriverManager.getConnection("jdbc:sqlite:corona.db")) {
            ...
            statement.execute("CREATE TABLE IF NOT EXISTS PATIENTS( CPF INTEGER PRIMARY KEY, RG INTEGER, NAME VARCHAR, EMAIL VARCHAR, SUSCARD VARCHAR, BORNDATE TEXT, ADDRESS VARCHAR, PASSWORD VARCHAR, STATUS VARCHAR )");
